...
function handleMessage(senderPsid, receivedMessage) {
    ...
    if (receivedMessage.text) {
      ...
      // will be added to the body of our request to the Send 
      response =
    ...
    console.log(response, '<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<')
      ...
      // response = {
      //   // 'text': `You sent the message: "${receivedMessage.text} ${senderPsid}". Now send me an attachment!`
      //   'text': `${localhost:8000/api/summaries}`
